...
/**
 * @brief Device Endpoint identifiers
 *
 * There are upto 8 EP in the USB OTG FS core, but only EP0 is mandatory for
 * the USB stack to work. Although, it is possible to use any of these EPs for
 * control or data transfer, it is a common practice to use EP0 for control
 * transfer, and EP1-7 for data transfer.
 */
typedef enum {
    USBOTG_FS_EP0 = 0,
    USBOTG_FS_EP1 = 1,
